<div class="font-serif fixed w-11/12 h-16 max-w-lg -translate-x-1/2 bottom-4 left-1/2 bg-blue-600 rounded-full z-40">
    <div class="flex justify-evenly w-full h-full">

        <x-bottom-navbar :href="route('dashboard')" :active="request()->routeIs('dashboard')" class="rounded-l-full" >
            <svg class="w-5 h-5 mb-1 group-hover:text-blue-950 text-blue-50 {{ request()->is('dashboard') ? 'text-blue-500':''}}" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
                <path  stroke="currentColor" fill="gray" stroke-linejoin="round" stroke-width="2"  d="m19.707 9.293-2-2-7-7a1 1 0 0 0-1.414 0l-7 7-2 2a1 1 0 0 0 1.414 1.414L2 10.414V18a2 2 0 0 0 2 2h3a1 1 0 0 0 1-1v-4a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1v4a1 1 0 0 0 1 1h3a2 2 0 0 0 2-2v-7.586l.293.293a1 1 0 0 0 1.414-1.414Z"/>
            </svg>
            {{ __('Home') }}
   
        </x-bottom-navbar>

        <x-bottom-navbar :href="route('status')" :active="request()->routeIs('status')">
        ...
        <x-bottom-navbar :href="route('settings')" :active="request()->routeIs('settings')">
        ...
        <x-bottom-navbar :href="route('user')" :active="request()->routeIs('user')" class="rounded-r-full" >
